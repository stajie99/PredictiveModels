CalculateFrictionandMismatch = function(dtCumulativeData, group){
  ...
  if(nrow(dtCumulativeData) > 1){
    cum_localEmptybr    = dtCumulativeData[-nrowDa, .(islocal_empty_cdg)] + dtCumulativeData[-nrowDa, .(islocal_empty_premier)] + 
                          dtCumulativeData[-nrowDa, .(islocal_empty_smrt)] + dtCumulativeData[-nrowDa, .(islocal_empty_transcab)]
    cum_foreignPickupbr = dtCumulativeData[-1, .(isforeign_pickup_phobooking_cdg)] + dtCumulativeData[-1, .(isforeign_pickup_tpbbooking_cdg)] +
                          dtCumulativeData[-1, .(isforeign_pickup_nonbooking_cdg)] + 
                          dtCumulativeData[-1, .(isforeign_pickup_phobooking_premier)] + dtCumulativeData[-1, .(isforeign_pickup_tpbbooking_premier)] +
                          dtCumulativeData[-1, .(isforeign_pickup_nonbooking_premier)] + 
                          dtCumulativeData[-1, .(isforeign_pickup_phobooking_smrt)] + dtCumulativeData[-1, .(isforeign_pickup_tpbbooking_smrt)] +
                          dtCumulativeData[-1, .(isforeign_pickup_nonbooking_smrt)] + 
                          dtCumulativeData[-1, .(isforeign_pickup_phobooking_transcab)] + dtCumulativeData[-1, .(isforeign_pickup_tpbbooking_transcab)] +
                          dtCumulativeData[-1, .(isforeign_pickup_nonbooking_transcab)]
    ...
    cum_leftEmptybr    = dtCumulativeData[-nrowDa, .(isleft_empty_cdg)] + dtCumulativeData[-nrowDa, .(isleft_empty_premier)] + 
                         dtCumulativeData[-nrowDa, .(isleft_empty_smrt)] + dtCumulativeData[-nrowDa, .(isleft_empty_transcab)]
