function [fn,qn,q0,fmean,mqn,gam,psi,stats] = time_warping1(f,t,lambda,option_parallel,option_closepool,option_smooth,option_sparam,option_showplot)
% default options
...
option.parallel = option_parallel;
option.closepool = option_closepool;
option.smooth = option_smooth;
option.sparam = option_sparam;
option.showplot = option_showplot;
if nargin < 3
    lambda = 0;
    option.parallel = 1;
    option.closepool = 0;
