...
% load('elecAlignedLog1.mat')
% f = log10(f+1);
% gam = gam';
% [pc,score,latent,tsquare] = princomp(gam);
% data = [scoregam(:,1) scoregam(:,2)]';
...
%       CurFigNum = CurFigNum + 1 ;
      ...
      kdeSM(vdata,paramstruct) ;
        ...
        title(titstr,'FontSize',12,'FontWeight','bold') ;
        vax = axis ;
        hold on ;
...
if iCovEdiagplot == 1 ;    %  Then make COVariance Estimation DIAGnostic PLOT
  ...
  ncut = 100 ;
  title('Robust Fit Gaussian Q-Q, All Pixel values','FontSize',12,'FontWeight','bold');
  xlabel('Gaussian,Q','FontSize',14,'FontWeight','bold');
  ylabel('Data Q','FontSize',14,'FontWeight','bold');
%   CurFigNum = CurFigNum + 1 ;
%   figure(CurFigNum) ;
%   clf ;
  subplot(2,3,4);
...
%   subplot(2,2,1) ;
    plot((1:d)',veigval,'ko-') ;
      ...
      title(titstr,'FontSize',12,'FontWeight','bold') ;
      xlabel('Component #','FontSize',14,'FontWeight','bold') ;
      ylabel('Eigenvalue','FontSize',14,'FontWeight','bold') ;
      if iCovEst == 2 ;
        vax = axisSM(veigval) ;
      else ;
  ...
  subplot(2,3,5) ;
    plot((1:dpos)',log10(veigvalpos),'ko-') ;
      title('log_{10} Eigenvalues','FontSize',12,'FontWeight','bold') ;
      xlabel('Component #','FontSize',14,'FontWeight','bold') ;
      ylabel('log_{10}(Eigenvalue)','FontSize',14,'FontWeight','bold') ;
      if iCovEst == 2 ;
...
%   clf ;
  ...
  vax = axis ;
  title('Gaussian Simulated Cluster Indices','FontSize',12,'FontWeight','bold');
  xlabel('Cluster Index','FontSize',14,'FontWeight','bold');
